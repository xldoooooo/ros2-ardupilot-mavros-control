...
RULES = {
    ...
    "scripts/lib/*": ("runtime", "flight", "video", "correction"),
    "scripts/onboard/components/*": ("runtime", "flight", "video", "correction"),
    ...
    "scripts/ground/setup_ground_station.sh": ("runtime", "video", "correction"),
